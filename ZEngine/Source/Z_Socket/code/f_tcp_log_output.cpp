...
//        log_data_ptr->log_type_ = zengine::log::Error;
...
//        TCPLogOutputReplyLogData* log_data_ptr = new TCPLogOutputReplyLogData();
//        log_data_ptr->log_type_ = zengine::log::Trace;
...
//        TCPLogOutputReplyLogData* log_data_ptr = new TCPLogOutputReplyLogData();
//        log_data_ptr->log_type_ = zengine::log::Info;
...
//            Z_LOG_ERROR(ret_val, link_code, "ZTCPServer::Open() link error!");
//            return ret_val;
//        }
//
//        //set end point
...
//        if (link_code != kOK) {
//            ret_val = error_code::kSocketErrorCode_LinkError;
//            Z_LOG_ERROR(ret_val, link_code, "ZTCPServer::SetEndpoint() link error!");
//            return ret_val;
//        }
//
//        //start log server
...
//                "ZLogServer::RegisterOutputFunction() link error!"
//            );
//        }
//        link_code = zengine::log::RegisterLogServerOutputFunction(
...
//                "ZTCPSingleSessionServer::SetEndpoint() link error!"
//            );
...
//                    "ZTCPSingleSessionServer::Accept() link error!"
//                );
//                Instance().log_server_.Close();
//                break;
//            }
...
//                        "Command ID not exist! ID: %d", command_id
//                    );
...
//            Z_LOG_ERROR(
//                error_code::kSocketErrorCode_LinkError, link_code, 
//                "ZTCPServer::Open() link error!"
//            );
//            Z_LOG_FAILURE("Log server open failed!");
...
//                Z_LOG_ERROR(
//                    error_code::kSocketErrorCode_LinkError, link_code,
//                    "ZTCPSingleSessionClient::Connect() link error!"
//                );
//            }
//            Z_LOG_FAILURE("Log server connect failed!");
//            Instance().log_client_.Close();
//            //call handle func
//            Instance().client_finish_handle_func_();
//            //shutdown
...
//                Z_LOG_ERROR(
//                    error_code::kFTCPLogOutputErrorCode_CommandIDNotExist, 0,
//                    "Command ID not exist! ID: %d", reply_ptr->reply_data_.command_not_exist_data_.command_id_
//                );
//                break;
//            default:
//                Z_LOG_ERROR(
//                    error_code::kFTCPLogOutputErrorCode_ReplyIDNotExist, 0, 
//                    "Reply ID not exist! ID: %d", reply_id
//                );
//                break;
//            }
//        }
...
//        Z_LOG_ERROR(
//            error_code::kFTCPLogOutputErrorCode_LinkError, link_code,
//            "ZTCPLogServer::StartServer() link error!"
//        );
//    }
//    return kOK;
//}
...
//        Z_LOG_ERROR(
//            error_code::kFTCPLogOutputErrorCode_LinkError, link_code,
//            "ZTCPLogServer::StopServer() link error!"
//        );
//    }
//    return kOK;
//}
...
//        Z_LOG_ERROR(
//            error_code::kFTCPLogOutputErrorCode_LinkError, link_code,
//            "ZTCPLogClient::StopClient() link error!"
//        );
//    }
//    return kOK;
//}
