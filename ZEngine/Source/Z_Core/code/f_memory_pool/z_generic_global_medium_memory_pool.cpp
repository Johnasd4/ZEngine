...
#include "m_log.h"
#include "z_generic_global_medium_memory_pool.h"

namespace zengine {
namespace memory_pool {

NOINLINE Void ZGenericGlobalMediumMemoryPool::ExtendMemoryBlockP() noexcept {
    ...
    UInt32 apply_memory_size;
    {
        ...
        apply_memory_size = apply_page_num * kMemoryAtomPageSize;
        //move page pointer
        memory_page_data_ptr->page_ptr_ += apply_memory_size;
    }

    unused_memory_block_ptr_ = page_ptr;
    unused_memory_block_end_ptr_ = page_ptr + apply_memory_size;
...
NOINLINE Void ZGenericGlobalMediumMemoryPool::ExtendMemoryPageP(MemoryPageData_* _memory_page_data_ptr) noexcept {
    static ZGenericMemoryPool generic_memory_pool;
    ...
    Byte* page_head_ptr = reinterpret_cast<Byte*>(
        generic_memory_pool.Alloc64KBAlignmentMemoryAtomPageP(
...
ZGenericGlobalMediumMemoryPoolGroup::ZGenericGlobalMediumMemoryPoolGroup() noexcept
    : pool_array_()
{
