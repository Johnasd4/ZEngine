...
#include "m_log.h"
#include "z_generic_global_small_memory_pool.h"

namespace zengine {
namespace memory_pool {

NOINLINE Void ZGenericGlobalSmallMemoryPool::ExtendMemoryBlockP() noexcept {
    MemoryPageData_& memory_page_data = MemoryPageDataInstanceP();
    MemoryPageHeadExtend_* page_ptr;
    {
        TLockGuard lock_guard(memory_page_data.mutex_);
        ...
        page_ptr = reinterpret_cast<MemoryPageHeadExtend_*>(memory_page_data.page_ptr_);
...
NOINLINE Void ZGenericGlobalSmallMemoryPool::ExtendMemoryPageP() noexcept {
...
ZGenericGlobalSmallMemoryPoolGroup::ZGenericGlobalSmallMemoryPoolGroup() noexcept
    : pool_array_()
{
