...
/*
    Frame class.
*/
class GUI_DLLAPI ZButton : public ZGuiAdjustableObject {
public:
    ...
    */
    ...
    Void BindCkickEvent(Void(*_click_event_ptr)(ZButton* _this_ptr)) noexcept;
...
private:
    ...
    Void(*click_event_ptr_)(ZButton* _this_ptr);
