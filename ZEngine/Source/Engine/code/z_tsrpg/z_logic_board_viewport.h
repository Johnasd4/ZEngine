...
enum ZLogicBoardViewerErrorCode : ReturnType {
    ...
    kZLogicBoardViewerErrorCode_NullptrParams
};
}//error_code
}//zengine
...
public:
    ...
    NODISCARD ZLogicTile* operator()(IndexType _x, IndexType _y) noexcept;
    NODISCARD ZLogicTile* const operator()(IndexType _x, IndexType _y) const noexcept;
    ...
    NODISCARD ZLogicTile* At(IndexType _x, IndexType _y) noexcept;
    NODISCARD ZLogicTile* const At(IndexType _x, IndexType _y) const noexcept;
    NODISCARD ZLogicTile* At(LogicVector2D _index) noexcept;
    NODISCARD ZLogicTile* const At(LogicVector2D _index) const noexcept;

    NODISCARD FORCEINLINE IndexType XLength() noexcept { return view_size_.x_; }
    NODISCARD FORCEINLINE IndexType YLength() noexcept { return view_size_.y_; }
