...
public:
    ...
    NODISCARD FORCEINLINE IndexType Size() const noexcept { return static_cast<IndexType>(map_.size()); }
    NODISCARD FORCEINLINE IndexType Capacity() const noexcept { return map_.bucket_count(); }
