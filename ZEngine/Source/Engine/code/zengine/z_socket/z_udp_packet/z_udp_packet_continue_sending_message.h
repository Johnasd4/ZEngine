...
*/
struct ZUDPPacketContinueSendingMessage : public ZUDPPacket {
public:
    static constexpr SizeType kPacketBodySize = 0ULL;

    FORCEINLINE ZUDPPacketContinueSendingMessage() noexcept
        : SuperType_(UDPPacketTypeEnum::kContinueSendingMessage)
    {}
    FORCEINLINE ~ZUDPPacketContinueSendingMessage() noexcept {}
