...
*/
struct ZUDPPacketStartSendingMessage : public ZUDPPacket {
public:
    static constexpr SizeType kPacketBodySize = 0ULL;

    FORCEINLINE ZUDPPacketStartSendingMessage() noexcept
        : SuperType_(UDPPacketTypeEnum::kStartSendingMessage)
    {}
    FORCEINLINE ~ZUDPPacketStartSendingMessage() noexcept {}
