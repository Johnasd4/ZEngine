...
*/
struct ZUDPPacketP2PKeepAlive : public ZUDPPacket {
public:
    static constexpr SizeType kPacketBodySize = 0ULL;

    FORCEINLINE ZUDPPacketP2PKeepAlive() noexcept
        : SuperType_(UDPPacketTypeEnum::kP2PKeepAlive)
    {}
    FORCEINLINE ~ZUDPPacketP2PKeepAlive() noexcept {}
