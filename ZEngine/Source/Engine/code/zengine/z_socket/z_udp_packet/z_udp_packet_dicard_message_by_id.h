...
/*
    Discard message by the given message id UDP packet.
    Structure:
...
*/
struct ZUDPPacketDiscardMessageByID : public ZUDPPacket {
public:
    static constexpr SizeType kMessageBodySize = 4;

    FORCEINLINE ZUDPPacketDiscardMessageByID() noexcept
        : SuperType_(UDPPacketTypeEnum::kDiscardMessageByID)
    {}
    FORCEINLINE ~ZUDPPacketDiscardMessageByID() noexcept {}
