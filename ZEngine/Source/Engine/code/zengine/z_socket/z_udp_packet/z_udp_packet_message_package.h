...
/*
    ...
    Structure:
        ...
        8 - END: data_(Byte[kDataSize])
*/
struct ZUDPPacketMessagePackage : public ZUDPPacket {
public:
    static constexpr SizeType kMessageHeadSize = 0ULL;
    static constexpr SizeType kPacketBodySize = ZUDPPacket::kMaxPacketBodySize;
    static constexpr SizeType kDataMaxSize = kPacketBodySize - kMessageHeadSize;

    FORCEINLINE ZUDPPacketMessagePackage() noexcept
        : SuperType_(UDPPacketTypeEnum::kMessagePackage)
    {}
    FORCEINLINE ~ZUDPPacketMessagePackage() noexcept {}
