...
/*
    Pause sending messages. Will not discard unsent messages.
    Structure:
...
*/
struct ZUDPPacketPauseSendingMessage : public ZUDPPacket {
public:
    static constexpr SizeType kPacketBodySize = 0ULL;

    FORCEINLINE ZUDPPacketPauseSendingMessage() noexcept
        : SuperType_(UDPPacketTypeEnum::kPauseSendingMessage)
    {}
    FORCEINLINE ~ZUDPPacketPauseSendingMessage() noexcept {}
