...
*/
struct ZUDPPacketStopSendingMessage : public ZUDPPacket {
public:
    static constexpr SizeType kPacketBodySize = 0ULL;

    FORCEINLINE ZUDPPacketStopSendingMessage() noexcept
        : SuperType_(UDPPacketTypeEnum::kStopSendingMessage)
    {}
    FORCEINLINE ~ZUDPPacketStopSendingMessage() noexcept {}
