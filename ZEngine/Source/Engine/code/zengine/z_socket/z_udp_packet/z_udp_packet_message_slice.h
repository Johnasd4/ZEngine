...
/*
    ...
    Structure:
        ...
        8 - 11: slice_id_(UInt32)
        12 - 15: message_id_(UInt32)
        16 - END: data_(Byte[kMaxMessageBodySize])
*/
struct ZUDPPacketMessageSlice : public ZUDPPacket {
public:
    static constexpr SizeType kSliceDataHeadSize = 8ULL;
    static constexpr SizeType kPacketBodySize = ZUDPPacket::kMaxPacketBodySize;
    static constexpr SizeType kDataSize = kPacketBodySize - kSliceDataHeadSize;

    FORCEINLINE ZUDPPacketMessageSlice() noexcept
        : SuperType_(UDPPacketTypeEnum::kMessageSlice)
    {}
    FORCEINLINE ~ZUDPPacketMessageSlice() noexcept {}
