...
constexpr Float64 kLogParameterLn2Reciprocal = 1.4426950408889634074;
constexpr Float64 kLogParameterLn10Reciprocal = 4.3429448190325182765E-01;
...
constexpr const NumberType Log2A(const NumberType number) noexcept {
    ...
    return internal::LnCalculateA(number) * static_cast<NumberType>(internal::kLogParameterLn2Reciprocal);
}
...
constexpr const NumberType LgA(const NumberType number) noexcept {
    ...
    return internal::LnCalculateA(number) * static_cast<NumberType>(internal::kLogParameterLn10Reciprocal);
}
