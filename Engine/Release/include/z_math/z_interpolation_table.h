...
public:
    ...
    */
    ...
    /*
        Search the table.
    */
    __forceinline constexpr const NumberType SearchTable(const IndexType index) const;
    /*
        Will search the table over again if the index is bigger then the table size.
    */
    __forceinline constexpr const NumberType LoopSearchTable(const IndexType index) const;
    /*
