#ifndef Z_MATH_BASIC_F_LOG_H_
#define Z_MATH_BASIC_F_LOG_H_
...
constexpr const NumberType LnA(const NumberType number) noexcept {
    ...
    return internal::LnCalculate(number);
}
...
constexpr const NumberType Log2A(const NumberType number) noexcept {
    ...
    return internal::LnCalculate(number) * static_cast<NumberType>(internal::kLogParameterLog2Reciprocal);
}
...
constexpr const NumberType LgA(const NumberType number) noexcept {
    ...
    return internal::LnCalculate(number) * static_cast<NumberType>(internal::kLogParameterLog10Reciprocal);
}
...
constexpr const NumberType LogA(const NumberType logarithm_number, const NumberType base_number) noexcept {
    ...
    return internal::LnCalculate(logarithm_number) / internal::LnCalculate(base_number);
}

}//math
}//zengine

#endif //!Z_MATH_BASIC_F_LOG_H_