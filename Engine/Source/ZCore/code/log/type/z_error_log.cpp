...
Void ZErrorLog::GenerateLogString(const ZLog* _log_ptr, OutputString_* _output_str_ptr) noexcept {
    ...
    string::String2WString(err_log.err_file_, &file_str);
    string::String2WString(err_log.err_func_, &func_str);
    ...
    _output_str_ptr->w_str_.SetString(
        ...
        err_log.err_project_, file_str.DataPtr(), func_str.DataPtr(), err_log.err_line_,
