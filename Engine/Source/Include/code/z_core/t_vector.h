...
public:
    ...
    FORCEINLINE TVector(const TVector& _vector) noexcept : SuperType_(), vec_(_vector.vec_) {}
    FORCEINLINE TVector(TVector&& _vector) noexcept : SuperType_(), vec_(std::move(_vector.vec_)) {}
    ...
    NODISCARD FORCEINLINE Bool operator==(const TVector& _vector) noexcept { return vec_ == _vector; }
    NODISCARD FORCEINLINE Bool operator!=(const TVector& _vector) noexcept { return vec_ != _vector; }
    ...
    FORCEINLINE Void Swap(TVector& _vector) noexcept { vec_.swap(_vector); }
