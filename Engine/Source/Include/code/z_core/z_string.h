...
public:
    ...
    FORCEINLINE constexpr TString(const TString& _string) noexcept : SuperType(), str_(_string.str_) {}
    FORCEINLINE constexpr TString(const TString& _string, SizeType _pos, SizeType _len = -1) noexcept
        : SuperType(), str_(_string.str_, _pos, _len) {}
    FORCEINLINE constexpr TString(TString&& _string) noexcept : SuperType(), str_(std::move(_string.str_)) {}

    FORCEINLINE constexpr TString(const _CharType* _string) noexcept : SuperType(), str_(_string) {}
    FORCEINLINE constexpr TString(const _CharType* _string, SizeType _size) noexcept 
        : SuperType(), str_(_string, _size) {}
    ...
    FORCEINLINE constexpr TString& Replace(const SizeType _pos, const SizeType _len, const TString& _string) noexcept {
        str_.replace(_pos, _len, _string.str_);
        return *this;
    }
    ...
    FORCEINLINE constexpr Void Swap(TString& _string) noexcept { str_.swap(_string); }
