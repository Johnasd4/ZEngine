...
private:
    friend FORCEINLINE constexpr TString operator+(const TString& left_str, const TString& right_str) noexcept;
...
template<typename CharType>
FORCEINLINE constexpr internal::TString<CharType> operator+(
    const internal::TString<CharType>& left_str,
    const internal::TString<CharType>& right_str) noexcept 
{
    internal::TString<CharType> temp_str;
    temp_str.string_ = left_str.string_ + right_str.string_;
    return temp_str;
}
